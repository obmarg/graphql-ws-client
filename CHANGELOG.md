...
- support multiple tungstenite versions
...
- raise pin-project dependency slightly ([#145](https://github.com/obmarg/graphql-ws-client/pull/145))
- avoid drop safety concerns in `Subscription.stop` ([#139](https://github.com/obmarg/graphql-ws-client/pull/139))
